...
async function loadLongTerm() {
    ...
    if (!document.getElementById("longterm-list")) return;
...
const addLongTermForm = document.getElementById("add-longterm-form");
if (addLongTermForm) {
    addLongTermForm.addEventListener("submit", async e => {
        e.preventDefault();
