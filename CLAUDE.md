...
- `src/safe_family/static/css/styles.css` is hand-maintained plain CSS (no build step). It uses `@layer reset, utilities` so un-layered custom rules always win; add new utility classes to the utilities layer sparingly and prefer semantic classes.
...
**Stack:** Python 3.11 · Flask · Flask-SQLAlchemy · Flask-JWT-Extended · APScheduler · psycopg2 · pandas · Jinja2/plain CSS · pytest
